...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      if (error) toast({ title: t("auth.errorLogin"), description: error.message, variant: "destructive" });
    } else {
      const { error } = await signUp(email, password, displayName);
      if (error) {
        toast({ title: t("auth.errorSignup"), description: error.message, variant: "destructive" });
      } else {
          ...
          <CardContent>
            ...
            <Button
              ...
              onClick={async () => {
                ...
                if (error) toast({ title: t("auth.googleError"), description: String(error), variant: "destructive" });
              }}
            >
