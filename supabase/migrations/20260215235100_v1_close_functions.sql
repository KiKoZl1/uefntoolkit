-- V1 close: functions/RPCs (source-of-truth interfaces + stable enqueue + intel update)

-- ===========================
-- 1) enqueue_discover_link_metadata (bump-controlled)
-- ===========================
-- Drop older signatures to avoid ambiguous resolution.
...
-- ===========================
-- 2) Canonical read RPCs (interfaces)
-- ===========================
...
-- ===========================
-- 3) Report helper RPCs (cheap aggregations)
-- ===========================
...
-- ===========================
-- 5) system alerts compute (materialize to system_alerts_current)
-- ===========================
...
BEGIN
  ...
  -- Exposure stale targets: last_ok older than 2*interval
  SELECT COUNT(*)::int
